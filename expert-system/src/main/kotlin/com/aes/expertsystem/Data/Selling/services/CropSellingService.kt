...
class CropSellingService(
    ...
    private fun linearJoinPoint(
        ...
        val dt =
            to.middleDate().atStartOfDay().toEpochSecond(ZoneOffset.UTC) -
                from.middleDate().atStartOfDay()
                    .toEpochSecond(ZoneOffset.UTC)
        val dtAtDate =
            atDate.atStartOfDay().toEpochSecond(ZoneOffset.UTC) -
                from.middleDate().atStartOfDay()
                    .toEpochSecond(ZoneOffset.UTC)
    ...
    private fun linearExtrapolate(
        ...
        val (to, from) =
            if (atDate < allData.last().fromDate) {
    ...
    private fun weightedExtrapolate(
        atDate: LocalDate,
        allData: List<CropPrice>,
    ): Float {
        val list =
    ...
    fun getExpectedPriceForDateInCountry(
        crop: String,
        date: LocalDate,
        country: String,
    ): Float {
